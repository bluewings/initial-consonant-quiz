const proverb: any = {
  ...
  '감나무 아래서 갓끈 메지말고, 오이밭에서 신 끈 메지마라.':
    '충분히 오해받을 수 있을만한 행동은 삼가라는 뜻.',
  '강 건너 불 보듯 한다':
    '자신과 관계가 없는 일처럼 전혀 걱정을 하지 않는다는 뜻.',
  '강철이 가을이다':
    '강철이가 지난 곳은 산천초목이 불타고 구름이 말라 황폐해 지므로, 극심한 흉년을 이르는 말.',
  '강철이 간 데는 가을도 봄(이라)':
    '다 되어가던 일을 하나의 원인때문에 그르치게 된 상황을 이르는 말.',
  ...
  '계란에도 뼈가 있다':
    '뼈가 있을리 없는 계란에도 뼈가 있어 계란마저 못 먹게 된 상황을 이르는 말로, 운이없는 사람이 하는 일마다 거듭 아니 풀리는 상황을 이르는 말.',
  ...
  '고양이 목에 방울 달기':
    '실행에 옮길 자신도 없으면서 공연히 의논만 하는 것을 뜻함. 또는 감히 할 수 없는 일을 이르는 말.',
  ...
  '굴러 온 돌이 박힌 돌 뺀다':
    '새로운 것이 기존의 것을 밀어내고 그 자리를 차지함을 이르는 말.',
  '굼벵이도 구르는 재주가 있다':
    '하찮고 쓸모없어보이는 것이나 사람이라도 하나의 쓸모나 재주는 있다는 뜻.',
  '굼벵이도 밟으면 꿈틀한다':
  ...
  '귀에 걸면 귀고리, 코에 걸면 코걸이':
    '자기에게 이로운 대로 이렇게도, 저렇게도 상황에 맞게 둘러 붙인다는 말.',
  '그림의 떡이다':
  ...
  '녹비에 가로 왈':
    '사람이 일정한 주견없이 남의 생각이나 말을 좇아 이리저리 옮겨다니는 것을 비꼬아 이르는 말.',
  '누울 자리 봐 가며 발 뻗는다':
  ...
  '도둑을 맞을라니 개도 아니 짖는다':
    '안좋은 일을 당한 사람은 어떻게 해도 벗어날 수 없다는 뜻.',
  '도둑질도 손발이 맞아야 한다':
  ...
  '딸이 셋이면 대문을 열어놓고 잠을 잔다.':
    '딸을 시집보내면 살림을 가져가는데에서 나온 말로, 딸이 맣으면 재산이 준다는 뜻.',
  ...
  '마누라가 이쁘면 처가말뚝을 보고도 절을 한다.':
    '아내가 귀하면 처가의 모든것도 귀하게 여긴다는 뜻으로, 한 가지가 좋아보이면 그와 관련된 모든것들이 좋아 보인다는 뜻.',
  '마파람에 게눈 감추듯 한다':
  ...
  '못 먹는 감 찔러나 본다':
    '자신이 갖지 못할 바에 남도 갖지못하게 한다는 뒤틀린 심보를 이르는 말.',
  '무소식이 희소식이다':
    '소식이 없다는것은 별 탈 없이 지내고있다는 의미이므로, 아우밀 없이 지내는 것이 제일이라는 뜻.',
  ...
  '불난 집에 부채질 한다':
    '안좋은 상황을 안좋은 마음을 먹고 부추겨 상황을 더욱 악화시킨다는 뜻.',
  '비 온 뒤에 땅이 굳어진다':
  ...
  '약방의 감초':
    '어떤 일이든지 빠짐없이 꼭 끼는 사람을 말함. 또는 대부분의 일에 빠져서는 안되는 중요한 것을 이르는 말.',
  '어물전 망신은 꼴뚜기가 시킨다':
    '못난 사람이 그와 같이 있는 동료까지 망신시킬 경우에 쓰이는 말.',
  '엎드려 절 받기':
    '상대편은 할 마음도 없는데 요구하여 절을 받는다는 말로, 억지로 요구하여 대접을 받는다는 뜻.',
  '엎어진 김에 쉬어 간다':
  ...
  '자식 겉 낳지 속 못 낳는다':
    '아무리 자식이라도 그 속은 부모와 다를 수 있다는 뜻.',
  '작은 고추가 더 맵다':
    '몸집이 작은 사람이 오히려 큰 사람보다 다부지고 재주가 뛰어나며 야무지다는 뜻으로, 하찮아 보이는 것이 더 큰 재주가 있을 때를 이르는 말.',
  '잘 되면 제 탓, 안 되면 조상 탓':
  ...
  '중매는 잘 하면 술이 석 잔이고, 못 하면 뺨이 석 대라':
    '사람의 혼인 중매는 매우 어려운 일이니 신중하게 해야 한다는 말로, 신중하게 처리해야 할 일을 이르는 말.',
  '중이 제 머리 못 깎는다':
  ...
  '첫 술에 배부르랴':
    '어떠한 일에서 첫번의 성과가 만족스럽지 못할 때, 이를 예상한듯이 또는 위로할 때 쓰는 말',
  ...
  '칼로 물 베기':
    '부부는 다투다가도 시간이 조금 흐르면 이내 풀려 사이가 다시 좋아진다는 뜻.',
  '칼을 꺼냈으면 무라도 잘라라':
    '어떠한 일을 시작하고 끝내려면 조그마한 성과라도 이루고 맺으라는 뜻.',
  ...
  '파리 날리다':
    '영업이나 일이 바쁘지 않고 한가롭거나 장사가 잘 안되는 것을 비유.',
